...
/**
 * Created by vagrant on 3/31/17.
 */

//The annotation aloows PDI to recognize this class as a database plugin

@DatabaseMetaPlugin(
        type = "MARIADB",
        typeDescription = "MariaDB"
)
public class MariaDBDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    /**
     * Returns the SQL query to execute in order to determine the field layout of the table.
     */
    @Override
    ...
    /**
     * Returns the sql query to determine if a table exists
     *
     * @param tablename
     * @return
     */
    ...
    /**
     * Return the sql query to determine if a field in a table exists
     *
     * @param columnname
     * @param tablename
     * @return
    ...
    /**
     * this method is used to generate DDL fro create table statements in spoon
     * @param v
     * @param tk
     * @param pk
     * @param use_autoinc
    ...
    /**
     * Return reserved words for the MariaDB
     * @return
     */
    ...
    @Override public String getExtraOptionsHelpText() {
        return "https://mariadb.com/kb/en/mariadb/about-mariadb-connector-j/";
    }

    public String[] getUsedLibraries() {
        return new String[] { "mariadb-java-client-1.5.9.jar" };
    }
